  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Active Volcano</h3>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Sacred to Maasai</h3>
                <p className="text-gray-600">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Unique Lava</h3>
                <p className="text-gray-600">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Night Climb</h3>
                <p className="text-gray-600">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#55331e] mb-4 font-serif">Climbing Information</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="p-8">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-[#55331e] mb-4 font-serif">Climb Details</h3>
                <div className="space-y-4">
            ...
            <Card className="p-8">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-[#55331e] mb-4 font-serif">Important Notes</h3>
