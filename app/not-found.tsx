  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 px-4">
      <div className="max-w-2xl mx-auto text-center">
        {/* 404 Illustration */}
        <div className="mb-8">
          <div className="text-9xl md:text-[12rem] font-bold text-[#f88f2f] opacity-20 leading-none">
            404
          </div>
        </div>

        {/* Heading */}
        <h1 className="text-3xl md:text-5xl font-serif font-bold text-[#55331e] mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button asChild size="lg" className="bg-[#f88f2f] hover:bg-[#e67e1e] text-white">
            <Link href="/">
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/about" className="text-sm text-[#f88f2f] hover:underline">
              About Us
            </Link>
            <span className="text-gray-300">•</span>
            <Link href="/itineraries" className="text-sm text-[#f88f2f] hover:underline">
              Safari Packages
            </Link>
            <span className="text-gray-300">•</span>
            <Link href="/contact" className="text-sm text-[#f88f2f] hover:underline">
              Contact Us
            </Link>
          </div>
        </div>
