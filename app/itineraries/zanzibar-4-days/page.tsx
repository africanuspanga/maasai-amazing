              ...
              <Card className="sticky top-24 shadow-xl border-2 border-cyan-200 bg-white">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <BookNowButton tourName="Zanzibar 4 Days / 3 Nights Package" className="w-full bg-[#0891b2] hover:bg-[#0e7490] text-white text-lg py-6">Book This Package</BookNowButton>
                    <Button
                      asChild
                      variant="outline"
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-cyan-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <BookNowButton tourName="Zanzibar 4 Days / 3 Nights Package" size="lg" className="bg-white text-[#0891b2] hover:bg-gray-100 text-lg px-8 py-3">Book Now</BookNowButton>
            <Button
              asChild
              size="lg"
              variant="outline"
