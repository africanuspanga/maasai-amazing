  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#55331e] mb-4 font-serif">Maasai Bomas</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-2xl font-bold text-[#55331e] mb-4 font-serif">Traditional Maasai Villages</h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#55331e] mb-4 font-serif">Hadzabe Tribes</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-[#55331e] mb-4 font-serif">Ancient Bushmen Traditions</h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#55331e] mb-4 font-serif">What You'll Experience</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Traditional Ceremonies</h3>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Traditional Skills</h3>
                <p className="text-gray-600">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-xl font-bold text-[#55331e] mb-3 font-serif">Community Support</h3>
                <p className="text-gray-600">
      ...
      <section className="py-16 bg-[#55331e] text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <BookNowButton tourName="Cultural Experience" size="lg" className="bg-[#f88f2f] hover:bg-[#e67e1a] text-white px-8">Book Cultural Experience</BookNowButton>
            <Button
              size="lg"
              variant="outline"
